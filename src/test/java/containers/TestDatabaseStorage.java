...
public class TestDatabaseStorage {
    ...
    void testDatabaseStorage(List myList, boolean isLinked){
        ...
        StorageConfig incorrectConfig = new StorageConfig("incorrect", "incorrect", "incorrect", 0, "incorrect", "incorrect");
